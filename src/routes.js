...
routes.post('/categories', categoryValidation.create, CategoryController.create);
routes.put('/categories/:id', categoryValidation.update, CategoryController.update);

routes.get('/products', ProductController.store);
routes.get('/products/:id', productValidation.index, ProductController.index);
routes.post('/products', productValidation.create, ProductController.create);
routes.put('/products/:id', productValidation.update, ProductController.update);
routes.delete('/products/:id', productValidation.destroy, ProductController.delete)
